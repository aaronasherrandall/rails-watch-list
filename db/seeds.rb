...
Bookmark.create(comment: 'Great action movie!', movie: movie1, list: list1)
Bookmark.create(comment: 'Very emotional film.', movie: movie2, list: list2)
Bookmark.create(comment: 'One of the greatest films ever made', movie: movie3, list: list2)
Bookmark.create(comment: 'Great cast and story.', movie: movie4, list: list3)
